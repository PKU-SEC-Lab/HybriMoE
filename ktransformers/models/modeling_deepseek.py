...
class MoEGate(nn.Module):
    def __init__(self, config, layer_idx):
        ...
        self.score_aware_cache = KScoreAwareCache(config.num_hidden_layers, self.n_routed_experts, 0.5, 2 * self.top_k)
    ...
    def forward(self, hidden_states):
        ...
        self.score_aware_cache.update_priority_scores(self.layer_idx, scores)
